...
@property (nonatomic, strong) NSMutableDictionary * _Nonnull shopsArray;
- (void)viewDidLoad;
...
- (void)showShops;
- (void)showShopDetail:(UIButton * _Nonnull)target;
...
@property (nonatomic, weak) UILabel * _Null_unspecified nameLabel;
